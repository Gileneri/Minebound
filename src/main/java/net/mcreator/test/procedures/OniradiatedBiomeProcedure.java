		...
		if (!world.isClientSide()) {
			if ((ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("test:higher"))) == (entity.level.dimension())
				...
				if ((new Object() {
					...
					if (!(entity instanceof LivingEntity _livEnt ? _livEnt.hasEffect(TestModMobEffects.DEADLYRADIATION.get()) : false)) {
						if (entity instanceof LivingEntity _entity)
							_entity.addEffect(new MobEffectInstance(TestModMobEffects.DEADLYRADIATION.get(), 20, 0, (false), (true)));
					}
				}
			}
		}
