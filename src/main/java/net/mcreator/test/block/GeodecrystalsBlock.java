...
public class GeodecrystalsBlock extends Block {
	public GeodecrystalsBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GREEN)
				.sound(new ForgeSoundType(1.0f, 1.0f, () -> new SoundEvent(new ResourceLocation("test:breaking_crystal")), () -> new SoundEvent(new ResourceLocation("test:footstep_crystals")),
						() -> new SoundEvent(new ResourceLocation("test:inventory_putdown1")), () -> new SoundEvent(new ResourceLocation("test:breaking_crystal")), () -> new SoundEvent(new ResourceLocation("test:silence"))))
