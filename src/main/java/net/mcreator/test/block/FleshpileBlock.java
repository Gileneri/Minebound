...
public class FleshpileBlock extends Block {
	public FleshpileBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_RED)
				.sound(new ForgeSoundType(1.0f, 1.0f, () -> new SoundEvent(new ResourceLocation("test:brain_breaking1")), () -> new SoundEvent(new ResourceLocation("test:footstep_brains")),
						() -> new SoundEvent(new ResourceLocation("test:inventory_putdown1")), () -> new SoundEvent(new ResourceLocation("test:brain_breaking1")), () -> new SoundEvent(new ResourceLocation("test:silence"))))
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A7fEww, a fleshy looking"));
		list.add(Component.literal("\u00A7fmaterial!"));
		list.add(Component.literal("___________________"));
