...
import net.mcreator.test.world.teleporter.OrbitalTeleporter;
import net.mcreator.test.world.teleporter.OrbitalPortalShape;
...
public class OrbitalPortalBlock extends NetherPortalBlock {
	...
	public void entityInside(BlockState state, Level world, BlockPos pos, Entity entity) {
		if (!entity.isPassenger() && !entity.isVehicle() && entity.canChangeDimensions() && !entity.level.isClientSide() && true) {
			...
			} else if (entity.level.dimension() != ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("test:orbital"))) {
				entity.setPortalCooldown();
				teleportToDimension(entity, pos, ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("test:orbital")));
			} else {
				entity.setPortalCooldown();
