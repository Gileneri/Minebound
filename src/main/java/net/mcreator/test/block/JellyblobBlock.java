	...
	public JellyblobBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GREEN)
				.sound(new ForgeSoundType(1.0f, 1.0f, () -> new SoundEvent(new ResourceLocation("test:brain_breaking1")), () -> new SoundEvent(new ResourceLocation("test:footstep_brains")),
						() -> new SoundEvent(new ResourceLocation("test:inventory_putdown1")), () -> new SoundEvent(new ResourceLocation("test:brain_breaking1")), () -> new SoundEvent(new ResourceLocation("test:footstep_brains"))))
