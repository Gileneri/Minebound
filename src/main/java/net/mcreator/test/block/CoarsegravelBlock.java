...
public class CoarsegravelBlock extends Block {
	public CoarsegravelBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_LIGHT_GRAY)
				.sound(new ForgeSoundType(1.0f, 1.0f, () -> new SoundEvent(new ResourceLocation("test:breaking_gravel")), () -> new SoundEvent(new ResourceLocation("test:footstep_gravel")),
						() -> new SoundEvent(new ResourceLocation("test:inventory_putdown1")), () -> new SoundEvent(new ResourceLocation("test:breaking_gravel")), () -> new SoundEvent(new ResourceLocation("test:silence"))))
