...
public class MineboundModSounds {
	...
	public static final RegistryObject<SoundEvent> FOOTSTEP_STONE = REGISTRY.register("footstep_stone", () -> new SoundEvent(new ResourceLocation("minebound", "footstep_stone")));
	...
	public static final RegistryObject<SoundEvent> FOOTSTEP_CLAY = REGISTRY.register("footstep_clay", () -> new SoundEvent(new ResourceLocation("minebound", "footstep_clay")));
}
