...
public class ErchiusGhostMobEntity extends Monster {
	public ErchiusGhostMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.ERCHIUS_GHOST_MOB.get(), world);
	}

	public ErchiusGhostMobEntity(EntityType<ErchiusGhostMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
