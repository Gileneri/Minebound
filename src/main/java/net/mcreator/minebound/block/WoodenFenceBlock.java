...
public class WoodenFenceBlock extends Block implements SimpleWaterloggedBlock {
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		return switch (state.getValue(FACING)) {
			default -> box(-1, 0, 6, 17, 15, 10);
			case NORTH -> box(-1, 0, 6, 17, 15, 10);
			case EAST -> box(6, 0, -1, 10, 15, 17);
			case WEST -> box(6, 0, -1, 10, 15, 17);
		};
	}
