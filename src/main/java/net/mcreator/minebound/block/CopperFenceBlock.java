...
public class CopperFenceBlock extends Block implements SimpleWaterloggedBlock {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public CopperFenceBlock() {
		super(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.TERRACOTTA_BROWN)
				...
				.strength(4f).lightLevel(s -> 1).requiresCorrectToolForDrops().noOcclusion().isRedstoneConductor((bs, br, bp) -> false));
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		return switch (state.getValue(FACING)) {
			default -> box(-1, 0, 6, 15, 15, 12);
			case NORTH -> box(1, 0, 4, 17, 15, 10);
			case EAST -> box(6, 0, 1, 12, 15, 17);
			case WEST -> box(4, 0, -1, 10, 15, 15);
		};
	}
