...
import net.mcreator.minebound.procedures.ConnectedPillarProcedureProcedure;
import net.mcreator.minebound.init.MineboundModBlocks;

import java.util.List;
import java.util.Collections;

public class PillarBlockMiddleBlock extends Block implements SimpleWaterloggedBlock {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public PillarBlockMiddleBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.STONE)
				...
				.strength(12f).requiresCorrectToolForDrops().noOcclusion().isRedstoneConductor((bs, br, bp) -> false));
	...
	public ItemStack getCloneItemStack(BlockState state, HitResult target, BlockGetter world, BlockPos pos, Player player) {
		return new ItemStack(MineboundModBlocks.PILLAR_BLOCK.get());
	}
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(MineboundModBlocks.PILLAR_BLOCK.get()));
	}

	@Override
	public void onPlace(BlockState blockstate, Level world, BlockPos pos, BlockState oldState, boolean moving) {
		super.onPlace(blockstate, world, pos, oldState, moving);
		ConnectedPillarProcedureProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
